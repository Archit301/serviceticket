...
const AdminticketName = () => {
        ...
        const fetchStats = async () => {
         try {
            let id=currentUser._id;
               ...
               const res=await fetch(`/backend/ticket/totalticketname/${id}`);
               //console.log(res)
  ...
  return (
    ...
    <div className="max-w-6xl mx-auto bg-white shadow-md rounded-lg p-6">
      <h1 className="text-4xl font-extrabold mb-8 text-gray-900">Total Tickets Created</h1>
      {tickets.length > 0 ? (
        ...
        <p className="text-center text-gray-500 text-lg">Tickets Created is not created yet </p>
      )}
    </div>
  </div>
  )
...
export default AdminticketName
